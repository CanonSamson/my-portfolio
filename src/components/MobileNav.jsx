        ...
        <div>
            ...
            </div>
            {
                ...
                <nav className=' sm:hidden'>
                    <div className='fixed h-screen w-[70%] right-0  bg-white shadow-2xl top-0 z-50 nav-anime'>
                    ...
                    <div onClick={toggler} className='fixed h-screen w-full right-0 bg-white/20 top-0 z-10 backdrop-blur-sm'></div>
                </nav>
            }
        </div >
    );
